  ...
  <div className="min-h-screen bg-background p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          <header className="space-y-2">
            ...
            <p className="text-muted-foreground">Format or minify SQL queries easily.</p>
          </header>
          ...
          <main>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter SQL to format or minify.</CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-6 md:grid-cols-[1fr,auto,1fr] items-start">
                  ...
                  <div className="flex flex-col gap-4 justify-center pt-10">
                    <Button type="button" onClick={handleFormat} disabled={!input}>
                      <WrapText className="mr-2 h-4 w-4" /> Format
                    </Button>
