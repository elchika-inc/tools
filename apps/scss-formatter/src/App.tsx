...
import { formatScss, minifyScss } from '@/utils/scssFormatter';
...
export default function App() {
  ...
  const handleFormat = () => {
    try {
      const result = formatScss(input, Number(indentSize));
      setOutput(result);
  ...
  <div className="min-h-screen bg-background p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          <header className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">SCSS Formatter</h1>
            <p className="text-muted-foreground">
              Format or minify your SCSS code with support for nesting, variables, and mixins.
            </p>
          </header>
