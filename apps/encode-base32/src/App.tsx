...
export default function App() {
  ...
  const handleDecode = () => {
    try {
      ...
      toast.add({ title: "Decoding failed", description: "Invalid Base32", type: "error" });
    }
  };
  ...
  <div className="min-h-screen bg-background p-8">
        <main className="max-w-6xl mx-auto space-y-6">
          <header className="space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Base32 Encoder / Decoder</h1>
            <p className="text-muted-foreground">Base32エンコード/デコードを行います。</p>
          </header>
          <Card>
            <CardHeader>
              <CardTitle>Converter</CardTitle>
              <CardDescription>テキストまたはBase32を入力してください。</CardDescription>
            </CardHeader>
              ...
              <div className="grid gap-6 md:grid-cols-[1fr,auto,1fr] items-start">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    id="output"
                    readOnly
                    className="flex min-h-[250px] w-full rounded-md border border-input bg-muted px-3 py-2 text-sm font-mono focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring resize-none"
                    value={output}
                  />
                </div>
              </div>
