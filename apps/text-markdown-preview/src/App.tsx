        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <main className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <textarea
                  aria-label="Markdownテキスト入力"
                  className="flex min-h-[500px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm font-mono placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring resize-none"
                  value={input}
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" size="sm" variant="ghost" onClick={copyHtml}>
